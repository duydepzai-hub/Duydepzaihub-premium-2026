...
local v466 = vu32:MakeWindow({
    Title = "Duydepzai hub [ Duydepzai-PREMIUM] : Blox Fruits",
    SubTitle = "Duyyyyyyyy2k11cucuhi",
...
if isfile(ESP_SIZE_FILE) then
	_G.ESPSize = tonumber(readfile(ESP_SIZE_FILE)) or 500
else
	_G.ESPSize = 500
	writefile(ESP_SIZE_FILE, "500")
end
                ...
                if _G.BringMonster and (StartBring and v1167.Name == MonFarm or v1167.Name == Mon and v1167:FindFirstChild("Humanoid") and v1167:FindFirstChild("HumanoidRootPart") and v1167.Humanoid.Health > 0 and (v1167.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 320) then
                    if v1167.Name == "Factory Staff" then
                        if (v1167.HumanoidRootPart.Position - PosMon.Position).Magnitude <= 250 then
                            ...
                            v1167.HumanoidRootPart.Size = Vector3.new(100, 100, 100)
...
v496:AddToggle({Title = "vô hạn tốc biến", Value = false, Callback = function(v1173)
    InfiniteSoru = v1173
end})
spawn(function()
    while task.wait(1) do
...
v496:AddToggle({Title = "vô hạn nhảy", Value = false, Callback = function(v1183)
    InfiniteGeppo = v1183
end})
spawn(function()
    while task.wait(1) do
...
v496:AddButton({Title = "đổi máy chủ", Callback = function()
    Hop()
end})
...
v496:AddToggle({
    Name = "ko bị ban",
    Description = "chuyển qua máy chủ khác sau 30p",
    Default = false,
    Callback = function(Value)
